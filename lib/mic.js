...
var mic = function mic(options) {
    ...
    var silenceFramesThreshold = options.silenceFramesThreshold || 0;
    var silenceVolumeThreshold = options.silenceVolumeThreshold || 1250;
    ...
    audioStream.setSilenceFramesThreshold(parseInt(silenceFramesThreshold, 10));
    audioStream.setSilenceVolumeThreshold(parseInt(silenceVolumeThreshold, 10));
